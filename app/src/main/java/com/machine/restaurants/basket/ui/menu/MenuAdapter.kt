...
class MenuAdapter(private val listener: OnItemClickListener) : RecyclerView.Adapter<MenuAdapter.MenuxAdapter>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MenuxAdapter {
        val binding = LayoutmenusBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return MenuxAdapter(binding)

    }

    override fun onBindViewHolder(holder: MenuxAdapter, position: Int) {
    ...
    inner class MenuxAdapter(private val binding: LayoutmenusBinding) :
